  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      <div className="col-span-1 flex items-center justify-between rounded-xl border border-slate-100 bg-white px-5 py-3 shadow-sm">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">A pagar</p>
      ...
      <div className="col-span-1 flex items-center justify-between rounded-xl border border-slate-100 bg-white px-5 py-3 shadow-sm">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Total do mês</p>
        <p className="text-xl font-black tracking-tight text-slate-900">
      ...
      <div className="col-span-1 flex items-center justify-between rounded-xl border border-slate-100 bg-white px-5 py-3 shadow-sm">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Já pago</p>
